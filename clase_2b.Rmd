...
.pull-left[
<P align="justify">`r emo::ji("geek")` Descargue por favor [aquí](https://leo4luffy.github.io/R_amigable.github.io/schedule/2_class.html) el conjunto de datos `starwars` con extensión __.csv__. Luego intente importar ese archivo usando la función `read.table()`.</p>
