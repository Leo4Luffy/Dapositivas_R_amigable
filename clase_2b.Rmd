...
<P align="justify">Independientemente del tipo de formato con que se almacene un conjunto de dato, se puede emplear una sola función del programa `R` base para llevar a cabo su lectura: la función `read.table()`.</p>
